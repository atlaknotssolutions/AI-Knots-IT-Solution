...
//           {/* Comments Section */}
//           <section className="mt-16 bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-8 border border-gray-200 dark:border-gray-800">
...
//                   {post.comments?.length === 1 ? "" : "s"} on this post
//                 </p>
//               </div>
//             </div>
...
//                     className={`rounded-3xl p-5 border ${isDark ? "border-gray-800 bg-gray-950" : "border-gray-200 bg-gray-50"}`}
//                   >
...
//                     </div>
//                     <p
//                       className={`text-base leading-7 ${isDark ? "text-gray-300" : "text-gray-700"}`}
//                     >
//                       {comment.comment}
//                     </p>
//                   </div>
...
//             ) : (
//               <div
//                 className={`rounded-3xl p-8 border ${isDark ? "border-gray-800 bg-gray-950" : "border-gray-200 bg-gray-50"}`}
//               >
      ...
      <main className="max-w-4xl mx-auto px-6 md:px-8 py-12 md:py-20">
        <article className={`prose max-w-none ${isDark ? "prose-invert" : ""}`}>
          {sanitizedDescription && sanitizedDescription !== sanitizedContent && (
            <p className={`text-2xl leading-relaxed mb-12 ${isDark ? "text-gray-300" : "text-gray-700"}`}>
              {sanitizedDescription}
            </p>
          )}
