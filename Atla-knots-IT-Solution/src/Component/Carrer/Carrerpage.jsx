...
//               <p className={`text-xl ${bodyClass}`}>Loading exciting opportunities...</p>
//             </div>
//           )}
...
//             <div className="text-center py-20">
//               <p className={`text-xl ${bodyClass}`}>No open positions right now. Please check back later!</p>
//             </div>
//           )}
...
//                   <div className={`mt-3 flex flex-wrap gap-4 text-sm ${bodyClass}`}>
//                     <span>•</span>
//                     <span className="capitalize">{job.category?.name || "Full-time"}</span>
                    
//                     {job.endDate && (
//                       <>
//                         <span>•</span>
//                         <span>Closes on: {new Date(job.endDate).toLocaleDateString('en-IN')}</span>
//                       </>
//                     )}
//                   </div>
...
//                 <div>
//                   <h3 className={`text-2xl font-bold ${headingClass}`}>Apply for</h3>
//                   <p className="text-red-600 font-semibold">{selectedJob.title}</p>
//                 </div>
//                 <button
//                   onClick={closeModal}
...
//                 <div>
//                   <label className={`block mb-1 text-sm font-medium ${bodyClass}`}>Full Name *</label>
//                   <input
//                     type="text"
//                     name="name"
//                     value={formData.name}
...
//                   <div>
//                     <label className={`block mb-1 text-sm font-medium ${bodyClass}`}>Email *</label>
//                     <input
//                       type="email"
//                       name="email"
...
//                   </div>
//                   <div>
//                     <label className={`block mb-1 text-sm font-medium ${bodyClass}`}>Phone *</label>
//                     <input
//                       type="tel"
//                       name="phone"
...
//                 <div>
//                   <label className={`block mb-1 text-sm font-medium ${bodyClass}`}>Cover Letter / Message</label>
//                   <textarea
//                     name="coverLetter"
//                     value={formData.coverLetter}
//                     onChange={handleInputChange}
//                     rows={5}
//                     className={`w-full px-4 py-3 rounded-lg border focus:outline-none focus:border-red-600 transition-colors resize-y min-h-[120px]
//                       ${isDark ? 'bg-gray-800 border-gray-700 text-white' : 'bg-white border-gray-300'}`}
//                     placeholder="Why are you excited about this role? Tell us about your experience..."
//                   />
//                 </div>

//                 {submitMessage.text && (
//                   <p className={`text-center font-medium py-2 rounded-lg
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div>
                  <label className={`block mb-1 text-sm font-medium ${bodyClass}`}>
                    Resume (PDF, DOC, DOCX) *
                  </label>
                  <div className={`border-2 border-dashed rounded-xl p-6 text-center transition-all hover:border-red-600
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 text-red-600 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 16a4 4 0 01-.88-7.903 5 5 0 018.962-2.585M15 11V5a3 3 0 00-6 0v6M12 19l-3-3m0 0l3-3m-3 3l3 3" />
                      </svg>
                      <span className="font-medium text-base">Click to upload your resume</span>
                      <span className="text-xs text-gray-500 mt-1">Max 5MB • PDF, Word files only</span>
                    </label>
                  </div>
                ...
                {submitMessage.text && (
                  <p className={`text-center font-medium py-3 rounded-lg
                    ${submitMessage.type === 'success' ? 'text-green-500 bg-green-500/10' : 'text-red-500 bg-red-500/10'}`}>
                    {submitMessage.text}
                  </p>
                )}
