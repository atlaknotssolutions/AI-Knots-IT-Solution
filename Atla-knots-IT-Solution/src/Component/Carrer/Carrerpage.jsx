...
function CareerPage() {
    ...
    const fetchJobs = async () => {
      try {
        ...
        const res = await fetch(
          "https://ai-knots-it-solution.onrender.com/jobapply",
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://ai-knots-it-solution.onrender.com/jobapplication/apply/${selectedJob._id}`,
        {
          method: "POST",
          body: formDataToSend,
  ...
  //     const res = await fetch(`https://ai-knots-it-solution.onrender.com/jobapplication/apply/${selectedJob._id}`, {
  //       method: 'POST',
  //       body: formDataToSend,
  //     });
