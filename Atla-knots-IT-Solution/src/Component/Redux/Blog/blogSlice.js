  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await fetch(
        "https://ai-knots-it-solution-1.onrender.com/api/blogcategory",
      );
...
export const fetchBlogPosts = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await fetch(
        "https://ai-knots-it-solution-1.onrender.com/api/product",
      );
...
export const fetchBlogPostById = createAsyncThunk(
  ...
  async (postId, { rejectWithValue }) => {
    try {
      const res = await fetch(
        `https://ai-knots-it-solution-1.onrender.com/api/product/${postId}`,
      );
...
export const incrementPostView = createAsyncThunk(
  ...
  async (postId, { rejectWithValue }) => {
    try {
      const res = await fetch(
        `https://ai-knots-it-solution-1.onrender.com/api/product/${postId}/view`,
        {
          method: "PUT",
        },
      );
...
export const togglePostLike = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      ...
      const res = await fetch(
        `https://ai-knots-it-solution-1.onrender.com/api/product/${postId}/like`,
        {
          method: "PUT",
...
export const sendCommentOtp = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      ...
      const res = await fetch(
        `https://ai-knots-it-solution-1.onrender.com/api/product/${postId}/send-otp`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
...
export const verifyCommentOtp = createAsyncThunk(
  ...
  async ({ postId, email, otp }, { rejectWithValue }) => {
    try {
      const res = await fetch(
        `https://ai-knots-it-solution-1.onrender.com/api/product/${postId}/verify-otp`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
...
export const postComment = createAsyncThunk(
  ...
  async ({ postId, email, comment }, { rejectWithValue }) => {
    try {
      const res = await fetch(
        `https://ai-knots-it-solution-1.onrender.com/api/product/${postId}/comment`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
